                ...
                <section class="inner-section">
                    <div class="container-fluid nopadding"> <img src="assets/custom/images/blog/01.jpg" class="img-responsive wow fadeInDown" data-wow-delay="0.6s" data-wow-offset="10">
                            ...
                            <ul class="media-list">
                                <li class="media">
                                    <div class="media-left">
                                        <a href="#"> <img class="media-object" alt="64x64" src="assets/custom/images/userpic02.jpg"> </a>
                                    </div>
                                    <div class="media-body">
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="#"> <img class="media-object" alt="64x64" src="assets/custom/images/userpic03.jpg"> </a>
                                            </div>
                                            <div class="media-body">
                                                <div class="post-data">
                                                    <div class="post-date">2014 Jun, 14</div>
                                                ...
                                                <div class="media">
                                                    <div class="media-left">
                                                        <a href="#"> <img class="media-object" data-src="holder.js/64x64" alt="64x64" src="assets/custom/images/userpic02.jpg"> </a>
                                                    </div>
                                                    <div class="media-body">
                                                        <div class="post-data">
                                                            <div class="post-date">2014 Jun, 14</div>
                                        ...
                                        <div class="media">
                                            <div class="media-left">
                                                <a href="#"> <img class="media-object" data-src="holder.js/64x64" alt="64x64" src="assets/custom/images/userpic04.jpg"> </a>
                                            </div>
                                            <div class="media-body">
                                                <div class="post-data">
                                                    <div class="post-date">2014 Jun, 14</div>
                        ...
                        <div class="wow fadeInDown" data-wow-delay="0.6s" data-wow-offset="10">
                            <div id="post-comment">
                                <h4 class="font-accident-one-light uppercase">Leave a Comment</h4> </div>
                            <div class="dividewhite2"></div>
                            <form action="#" method="post" novalidate="novalidate">
                                <div class="row">
                                    <div class="col-md-4">
                                        <p>
                                            <label>Name*</label>
                                            <input type="text" name="your-name" value="" size="60" class="" aria-required="true" aria-invalid="false"> </p>
                                    </div>
                                    <div class="col-md-4">
                                        <p>
                                            <label>Email*</label>
                                            <input type="text" name="your-email" value="" size="60" class="" aria-required="true" aria-invalid="false"> </p>
                                    </div>
                                    <div class="col-md-4">
                                        <p>
                                            <label>Website</label>
                                            <input type="text" name="your-website" value="" size="60" class="" aria-required="true" aria-invalid="false"> </p>
                                    </div>
                                    <div class="col-md-12">
                                        <p>
                                            <label>Message</label>
                                            <textarea name="your-message" cols="60" rows="3" class="" aria-invalid="false"></textarea>
                                        </p>
                                    </div>
                                </div>
                                <div class="dividewhite2"></div>
                                <p>
                                    <button type="button" class="btn btn-lg btn-darker">Post Comment</button>
                                </p>
                            </form>
                        </div>
                    </div>
