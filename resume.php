                ...
                <section id="m-details" class="inner-section bg-color02">
                    <div class="container-fluid nopadding">
                        <div class="wow fadeInDown" data-wow-delay="0.4s" data-wow-offset="10">
                            ...
                            <p class="small text-center fontcolor-medium"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam id metus purus. </p>
                            ...
                            <div class="col-md-3 infoblock text-center wow fadeInLeft" data-wow-delay="0.6s" data-wow-offset="10">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <p class="small"> For extreme size changes, we may want to change the layout altogether, either through a separate style sheet or, more efficiently, through a CSS media query. </p>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-3 infoblock text-center wow fadeInUp" data-wow-delay="0.6s" data-wow-offset="10">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <p class="small"> It is possible to shrink things proportionally and rearrange elements as necessary to make everything fit (reasonably well) as a screen gets smaller. </p>
                                    </div>
                                </div>
                                <div class="divider-dynamic"></div>
                            </div>
                            <div class="col-md-3 infoblock text-center wow fadeInUp" data-wow-delay="0.6s" data-wow-offset="10">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <p class="small"> Below we have a few examples of responsive Web design in practice today. For many of these websites, there is more variation. </p>
                                    </div>
                                </div>
                                <div class="divider-dynamic"></div>
                            </div>
                            <div class="col-md-3 infoblock text-center wow fadeInRight" data-wow-delay="0.6s" data-wow-offset="10">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <p class="small"> One major problem that needs to be solved with responsive Web design is working with images. There are a number of techniques. </p>
                                    </div>
                                </div>
                                <div class="divider-dynamic"></div>
                            </div>
                ...
                <section id="timeline-vertical" class="inner-section">
                    <div class="container-fluid nopadding">
                        <div class="text-center wow fadeInDown" data-wow-delay="0.6s" data-wow-offset="10">
                            ...
                            <h5 class="font-accident-one-bold uppercase subtitle">Working hard and making the success</h5>
                            <div class="dividewhite1"></div>
                            <p class="small fontcolor-medium"> Customize your website as you want using different colors and 100% free fonts. Build it from pieces and blocks as simple as Lego.
                            ...
                            <li>
                                ...
                                <div class="timeline-panel wow fadeInLeft" data-wow-delay="0.3s" data-wow-offset="10">
                                    ...
                                    <div class="timeline-heading">
                                        ...
                                        <h6 class="uppercase">Junior Designer</h6> </div>
                                </div>
                            </li>
                            <li class="timeline-inverted">
                                ...
                                <div class="timeline-panel wow fadeInRight" data-wow-delay="0.3s" data-wow-offset="10">
                                    ...
                                    <div class="timeline-heading">
                                        ...
                                        <h6 class="uppercase">Senior Designer</h6> </div>
                                </div>
                            </li>
                            <li>
                                ...
                                <div class="timeline-panel wow fadeInLeft" data-wow-delay="0.3s" data-wow-offset="10">
                                    ...
                                    <div class="timeline-heading">
                                        ...
                                        <h6 class="uppercase">Art Director</h6> </div>
                                </div>
                            </li>
                            <li class="timeline-inverted info">
                                ...
                                <div class="timeline-panel wow fadeInRight" data-wow-delay="0.3s" data-wow-offset="10">
                                    ...
                                    <div class="timeline-heading">
                                        ...
                                        <h6 class="uppercase">Head of UX Department</h6> </div>
                                </div>
                            </li>
                        </ul>
